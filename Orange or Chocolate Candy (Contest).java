...
Input
The first line of input contains 5 integers X, Y, A, B, and C.
...
Explanation:-
Pino eats the 2nd chocolate candy (happiness=4), then eats the 1st orange candy (happiness=4+5=9), then transforms the first unknown candy to orange candy and eats it (happiness=9+3=12)
 */
