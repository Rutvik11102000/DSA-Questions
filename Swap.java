...
Input
User Task:
Since this will be a functional problem, you don't have to take input. You just have to complete the function Swap() that takes integers A and B as a parameter.
Output
